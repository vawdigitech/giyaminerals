                                            ...
                                            @forelse($sites as $site)
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input"
                                                        ...
                                                        name="site_ids[]"
                                                        value="{{ $site->id }}"
                                                        {{ (is_array(old('site_ids')) ? in_array($site->id, old('site_ids')) : $project->sites->contains($site->id)) ? 'checked' : '' }}>
                                            ...
                                            @forelse($factories as $factory)
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input"
                                                        ...
                                                        name="factory_ids[]"
                                                        value="{{ $factory->id }}"
                                                        {{ (is_array(old('factory_ids')) ? in_array($factory->id, old('factory_ids')) : $project->factories->contains($factory->id)) ? 'checked' : '' }}>
