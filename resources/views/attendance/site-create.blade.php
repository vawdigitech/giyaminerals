@extends('layouts.app')
@section('page_title', 'Create Site Attendance Record')
@section('breadcrumb')
    ...
    <div class="container-fluid">
        ...
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title"><i class="fas fa-plus mr-2"></i>Create New Site Attendance Record</h3>
            </div>

            <form action="{{ route('site-attendance.store') }}" method="POST">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                ...
                <div class="card-footer">
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save mr-1"></i> Create Site Attendance Record
                    </button>
