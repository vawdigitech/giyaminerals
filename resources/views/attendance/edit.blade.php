@extends('layouts.app')
@section('page_title', 'Edit Attendance Record')
@section('breadcrumb')
    ...
    <div class="container-fluid">
        ...
        <div class="card card-warning">
            <div class="card-header">
                <h3 class="card-title"><i class="fas fa-edit mr-2"></i>Edit Attendance Record</h3>
            </div>
            ...
            <form action="{{ route('attendance.update', $attendance) }}" method="POST">
                ...
                <div class="card-footer">
                    <button type="submit" class="btn btn-warning">
                        <i class="fas fa-save mr-1"></i> Update Attendance Record
                    </button>
