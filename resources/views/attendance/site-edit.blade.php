@extends('layouts.app')
@section('page_title', 'Edit Site Attendance Record')
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('dashboard.index') }}">Dashboard</a></li>
    <li class="breadcrumb-item"><a href="{{ route('site-attendance.index') }}">Site Attendance</a></li>
    ...
    <div class="container-fluid">
        ...
        <div class="card card-warning">
            <div class="card-header">
                <h3 class="card-title"><i class="fas fa-edit mr-2"></i>Edit Site Attendance Record</h3>
            </div>

            <form action="{{ route('site-attendance.update', $attendance) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="card-body">
                    <div class="row">
                ...
                <div class="card-footer">
                    <button type="submit" class="btn btn-warning">
                        <i class="fas fa-save mr-1"></i> Update Site Attendance Record
                    </button>
                    <a href="{{ route('site-attendance.index') }}" class="btn btn-secondary">
